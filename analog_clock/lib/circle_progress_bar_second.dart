...
class CircleProgressBar2 extends StatelessWidget {
...
class CircleProgressBarPainter extends CustomPainter {
  ...
  CircleProgressBarPainter({
    ...
    double strokeWidth,
  }) : this.strokeWidth = strokeWidth ?? 14;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final radius = shortestSide * 0.5 * 1;
    ...
    final double sweepAngle =
        this.percentage; //(2 * Math.pi * (this.percentage ?? 0));
